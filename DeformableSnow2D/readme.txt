...
1. Box Colliders - due to optimization, the box colliders haven't any calculations except the size, so the it's not working with rotation - however for "pixel perfect" collision you can still use polygon collider
2. Polygon colliders are probably quite expensive due to many calculations, so I recommend use them in small amount :)
...
https://github.com/Satik64/DeformableSnow2D
www.satik64.com
satik64@gmail.com