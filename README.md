...
## Use of example
You can use my predefined meshes with ready-to-place GameObjects in example scene. which should working without problems. I have one smaller snow and one long which is fitting the most level scenarious. You can adjust the diffuse texture, replace with custom material or use it at it is :)
